...
with open(r'D:\Minor project\Car Traffic 2\parking_spots.json', 'rb') as f:
    posList = json.load(f)

# Capture from camera or video
cap = cv2.VideoCapture(r"D:\Minor project\Car Traffic 2\Car_Parking_Space_Detector_YOLOv8\input_video\parking_space.mp4")  # Change to the appropriate source if not using a webcam
# get vcap property
